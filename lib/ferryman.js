...
class Ferryman {
    ...
    invokeModuleFunction(moduleFunction, data, passedFunction) {
        ...
        return co(function* gen() {
            const module = yield this.componentReader.loadTriggerOrAction(passedFunction ? passedFunction : settings.FUNCTION);
        ...
        return new Promise(resolve => {
            ...
            async function onData(data) {
                ...
                try {
                    ...
                    const result = await self.amqpConnection.sendData(data, headers, self.throttles.data);
                    await self.amqpConnection.sendBackChannel(headers, self.throttles.data);
                    return result;
                } catch (err) {
                    return onError(err);
                }
