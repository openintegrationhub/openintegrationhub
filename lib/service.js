...
function processService(serviceMethod, env){
    ...
    var API_URI = env.API_URI;
    var API_USERNAME = env.API_USERNAME;
    ...
    function init() {
        ...
        assert(CFG, 'API_URI is not provided');
        assert(CFG, 'API_USERNAME is not provided');
        assert(CFG, 'API_KEY is not provided');
