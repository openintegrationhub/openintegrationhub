...
const validateVirtualComponent = (virtualComponent, user) => {
...
const loadVirtualComponent = async (req, res, next) => {
  ...
  if (!virtualComponent || validateVirtualComponent(virtualComponent, user)) {
...
module.exports = ({ iam }) => {
  ...
  const GetVirtualComponent = asyncHandler(require('./GetVirtualComponent'))
  ...
  router.post('/:id/:componentVersionId/config',loadVirtualComp,validateVirtualComponent, CreateComponentConfig);
  router.patch('/:id/:componentVersionId/config',loadVirtualComp,validateVirtualComponent, UpdateComponentConfig);
