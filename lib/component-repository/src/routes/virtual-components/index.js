...
module.exports = ({ iam }) => {
  ...
  router.post('/:id/:componentVersionId/config',loadVirtualComp, bodyParser, CreateComponentConfig);
  router.patch('/:id/:componentVersionId/config',loadVirtualComp, bodyParser, UpdateComponentConfig);
