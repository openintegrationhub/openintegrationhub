...
describe('Get Default Component versions configs', () => {
  ...
  it('should return three components version configurations to the permitToken user', async () => {
  ...
  it('should return four components version configurations to the admin', async () => {
    const { body, statusCode } = await request(server.getApp())
      .get('/virtual-components/defaults/config')
