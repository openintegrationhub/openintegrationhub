...
describe('GET /components/global/:id/...', () => {
    ...
    it('should not start a global component if permission is missing', async () => {
        ...
        const { body, statusCode } = await request(server.getApp()).get(`/components/global/${component.id}/start`);
    ...
    it('should not stop a global component if permission is missing', async () => {
        ...
        const { body, statusCode } = await request(server.getApp()).get(`/components/global/${component.id}/stop`);
...
describe('GET /components/global/:id/...', () => {
    ...
    it('should return an error while starting a global component if the component is not found', async () => {
        const { body, statusCode } = await request(server.getApp()).get('/components/global/5e63c3a5e4232e4cd0274ac2/start');
    ...
    it('should return an error while stopping a global component if the component is not found', async () => {
        const { body, statusCode } = await request(server.getApp()).get('/components/global/5e63c3a5e4232e4cd0274ac2/stop');
    ...
    it('should not start a normal component by ID', async () => {
        ...
        const { body, statusCode } = await request(server.getApp()).get(`/components/global/${localComponent.id}/start`);
    ...
    it('should not stop a normal component by ID', async () => {
        ...
        const { body, statusCode } = await request(server.getApp()).get(`/components/global/${localComponent.id}/stop`);
