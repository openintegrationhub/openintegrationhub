...
ApiClient.prototype.auth = function (email, secret) {
    this.auth = {
        username: email,
        password: secret
    };
...
ApiClient.prototype.updateKeys = function (accountId, keys) {
...
ApiClient.prototype.put = function (path, data, expectedCodes) {
    var params = {
