...
ComponentReader.prototype.loadTriggerOrAction = function loadTriggerOrAction(name) {
    ...
    try {
        ...
        var message = "Trigger or action '%s' is found, but can not be loaded. "
            + "Please check if the file '%s' is correct.";

        if (err.code === 'MODULE_NOT_FOUND') {
            message = "Trigger or action '%s' is not found. "
                + "Please check if the path you specified in component.json ('%s') is valid.";
        }
