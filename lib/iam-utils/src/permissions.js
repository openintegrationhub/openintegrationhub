...
module.exports = {
    ...
    restricted: {
        ...
        'workflows.workflow.deleteAny': 'workflows.workflow.deleteAny',
    ...
    common: {
        ...
        'rds.rawRecord.read': 'rds.rawRecord.read',
        'rds.rawRecord.write': 'rds.rawRecord.write',

        'workflows.workflow.manage': 'workflows.workflow.manage',
