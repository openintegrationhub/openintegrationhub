...
module.exports = {
    getUserData: async ({ token, introspectType }) => {
        ...
        try {
            ...
            // @todo: needs to be tested manually because there is no test!
            ...
            if (introspectType.toLowerCase() === CONSTANTS.AUTH_TYPES.oidc) {
            ...
            const response = await fetch(introspectEndpoint, options);
