...
module.exports = class Server {
    constructor({
        ...
        apiBase.use('/callback', cors(this.corsOptions), require('./../route/callback'));
        apiBase.use(this.iam.middleware);

        // setup routes
        apiBase.use('/secrets', cors(this.corsOptions), new SecretsRouter({ iam: this.iam }));
        apiBase.use('/auth-clients', cors(this.corsOptions), new AuthClientRouter({ iam: this.iam }));
