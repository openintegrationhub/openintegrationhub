      ...
      || !message.properties.headers.orchestratorToken
        ...
        return new Promise((resolve) => {
            ...
            const onData = async (data) => {
                ...
                const currentApplicationUid = (data.metadata && data.metadata.applicationUid)
                    ? data.metadata.applicationUid : passedCfg.nodeSettings.applicationUid;
            ...
            async function onSnapshot(data) {
                ...
                return self.amqpConnection.sendSnapshot(data, headers, self.throttles.snapshot, tokenData.flowExecId);
            }
            ...
            async function onUpdateSnapshot(data) {
                ...
                if (_.isPlainObject(data)) {
                    ...
                    // eslint-disable-next-line
                    return self.amqpConnection.sendSnapshot(data, headers, null, this.snapshotRoutingKey, tokenData.flowExecId);
                }
