      ...
      || !message.properties.headers.orchestratorToken
        ...
        return new Promise((resolve) => {
            ...
            const onData = async (data) => {
                ...
                console.log('self.nodeSettings', JSON.stringify(self.nodeSettings));
                ...
                if (self.nodeSettings && self.nodeSettings.applyTransform
                  && (self.nodeSettings.applyTransform === 'after' || self.nodeSettings.applyTransform === 'both')) {
                    const cfg = {
                        customMapping: self.nodeSettings.secondTransformFunction
                            ? self.nodeSettings.secondTransformFunction : self.nodeSettings.transformFunction
                    };
                    const transformedMsg = transform(message, cfg, false);
                    data = transformedMsg;
                }
                ...
                if (self.settings.DATAHUB_BASE_URL && cfg.nodeSettings.idLinking) {
                    ...
                    if (getIdMetaResult && getIdMetaResult.refs && Array.isArray(getIdMetaResult.refs)) {
                        for (let ref of getIdMetaResult.refs) {
                            if (ref.applicationUid === self.nodeSettings.applicationUid) {
                    ...
                    if (dataHubEntryHasRecordUid === false) {
                        ...
                        const applicationUid = self.nodeSettings.applicationUid || self.oihMeta.applicationUid;
