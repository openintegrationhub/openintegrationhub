                      ...
                      && passedCfg.nodeSettings.governance
                        ...
                        if (passedCfg && passedCfg.deletes && data.data.delete) {
                            ...
                            if (data.data.delete === 'confirmed') {
                                ...
                                if (response === false) {
                                    // eslint-disable-next-line
                                    log.error(`DataHub update failed. RecordUid: ${savedMeta.recordUid} not found in entry: ${oihUid}`);
                                } else if (response === null) {
                                    // eslint-disable-next-line
                                    log.error(`DataHub update failed for recordUid: ${savedMeta.recordUid} oihUid: ${oihUid}`);
                                }
                            }
                        }
