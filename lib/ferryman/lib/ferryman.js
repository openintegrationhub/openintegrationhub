    ...
    // eslint-disable-next-line consistent-this
      ...
      || !message.properties.headers.orchestratorToken
        ...
        if (this.oihMeta.refs && Array.isArray(this.oihMeta.refs) && this.nodeSettings && payload.metadata) {
            console.log('Checking refs for app', this.nodeSettings.applicationUid);
            for (let ref in this.oihMeta.refs) {
                console.log('Current app', ref.applicationUid);
        ...
        return new Promise((resolve) => {
            ...
            const onData = async (data) => {
                ...
                try {
                    ...
                    console.log('oihMeta', this.oihMeta);
