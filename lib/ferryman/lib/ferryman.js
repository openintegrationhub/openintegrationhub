...
class Ferryman {
    ...
    async generateProvenanceEvent(data, headers) { //eslint-disable-line no-unused-vars
        ...
        const newEvent = { //eslint-disable-line no-unused-vars
            ...
            activity: {
                ...
                'flowId': data.flowId,
                'prov:startTime': data.startTime,
                'prov:endTime': data.endTime
            },
            agent: {
                kind: 'Connector',
                id: data.connectorId
        ...
        // return await self.amqpConnection.sendGovernanceChannel(newData, headers, self.throttles.data);
    }
        ...
        return new Promise((resolve) => {
            ...
            const onData = async (data) => {
                ...
                try {
                    ...
                    this.generateProvenanceEvent({ // eslint-disable-line
                        oihUid: payload.id, //?
