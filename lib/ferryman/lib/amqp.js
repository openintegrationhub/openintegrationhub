...
class Amqp {
            ...
            if (!this.hasSubscribeChannel) {
                try {
                    ...
                    this.subscribeChannel.on('error',(e)=>{
                        ...
                        log.error('Subscribe channel closed');
                    });
            ...
            if (!this.hasPublishChannel) {
                try {
                    ...
                    this.publishChannel.on('error', (e)=>{
                        ...
                        log.error('Publish channel closed');
                    });
    ...
    decryptMessage(callback, message) {
        ...
        if (message === null) {
            log.criticalErrorAndExit('RabbitMQ channel closed', new Error('NULL message received, channel has been closed'));
        }
