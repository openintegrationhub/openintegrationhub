...
describe('ferryman message processing with ID-Linking', () => {
    beforeEach(()=>{
        ...
        this.sandbox.stub(request, 'post');
        const envVars = {};
    ...
    it.only('should return 200 if import is successful', async () => {
        const payload = {
            data: {
                key: 'value'
            },
        ...
        expect(request.get).to.have.been.calledWith('http://localhost:1234/data/recordId/record-abc');
