...
function makeOrchestratorToken(action, secretId) {
    return jwt.sign({
...
describe('Ferryman', () => {
    ...
    describe('processMessage', () => {
        ...
        it('should handle missing secret gracefully', async () => {
            ...
            sandbox.stub(ferryman, 'fetchSecret').resolves({});

            const orchestratorToken = makeOrchestratorToken('data_trigger', 'secretId');
            ...
            const result = await ferryman.processMessage(payload, message);
