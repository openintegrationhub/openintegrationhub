    ...
    setupAMPQRecover() {
        ...
        this._amqpChannelWrapper.addSetup( async (channel) => {
            try {
                ...
                // ensure credentials step by step to prevent dos
                ...
                for (const globalComponent of globalComponents) {
                    // recover global components
                    await this._queuesManager.ensureCredentials({ id: globalComponent }, null, null)
                }
