...
class ComponentOrchestrator {
    ...
    async _purgeSnapshots(flowId, flowExecId) {
        await this._snapshotsDao.deleteSnapshots(flowId, flowExecId)
        this._logger.info({ flowId, flowExecId  }, 'Snapshots purged.');
    }
    ...
    _checkFlowProgress(flowId, stepId, flowState) {
        ...
        if (flowState.started === flowState.succeeded) {
            ...
            this._purgeSnapshots(flowId, flowState.flowExecId)
        }
    }
