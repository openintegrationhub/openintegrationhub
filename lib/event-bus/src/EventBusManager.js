...
class EventBusManager {
    ...
    init({ eventBus, rabbitmqUri, serviceName, onCloseCallback, onErrorCallback, onReconnectCallback }) {
        if (eventBus) {
            this.EventBus = eventBus;
        } else {
            this.EventBus = new EventBus({ serviceName, rabbitmqUri, onCloseCallback, onErrorCallback, onReconnectCallback });
        }
