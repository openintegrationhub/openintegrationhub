...
var HEADER_ROUTING_KEY = 'x-eio-routing-key';
var HEADER_ERROR_RESPONSE = 'x-eio-error-response';
...
AMQPConnection.prototype.sendData = function sendData(data, headers) {
    ...
    var msgHeaders = data.headers || {};

    var routingKey = getRoutingKeyFromHeaders(msgHeaders) || settings.DATA_ROUTING_KEY;
