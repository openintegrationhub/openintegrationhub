...
AMQPConnection.prototype.prepareMessageAndSendToExchange
    = function prepareMessageAndSendToExchange(data, properties, routingKey) {
...
AMQPConnection.prototype.sendData = function sendData(data, properties) {
    const settings = this.settings;
...
AMQPConnection.prototype.sendHttpReply = function sendHttpReply(data, properties) {
...
AMQPConnection.prototype.sendError = function sendError(err, properties, originalMessageContent) {
    const settings = this.settings;
    ...
    if (headers.reply_to) {
        ...
        var replyToOptions = _.cloneDeep(properties);
...
AMQPConnection.prototype.sendRebound = function sendRebound(reboundError, originalMessage, properties) {
    const settings = this.settings;
...
AMQPConnection.prototype.sendSnapshot = function sendSnapshot(data, properties) {
    const settings = this.settings;
