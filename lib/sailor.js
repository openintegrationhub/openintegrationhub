    ...
    shutdown() {
        return co(function* doShutdown() {
            ...
            try {
                ...
                console.log('startupData', startupData, typeof startupData);
            } catch (e) {
                console.log('startupData fail', e);
                if (!e === 404) {
                    //@todo log errors if not 404 error
                }
            }
            return yield this.invokeModuleFunction('shutdown', startupData);
        }.bind(this));
    }
