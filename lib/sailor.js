...
Sailor.prototype.processMessage = function processMessage(payload, message) {
    ...
    var snapshot = sailor.getStepSnapshot(stepId);
    ...
    function processMessageWithModule(module) {
        ...
        taskExec.process(module, payload, cfg, sailor.snapshot);
        ...
        function onUpdateSnapshot(data) {
            ...
            if (_.isPlainObject(data)) {
                if (data.$set) {
                    return console.warn('DEPRECATED: $set is not supported any more');
                }
