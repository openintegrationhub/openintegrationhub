...
class Sailor {
    ...
    processMessageAndMaybeShutdownCallback(payload, message) {
        return this.processMessage(payload, message)
            .finally(result => {
                if (!this.shutdownCallback) {
                    // shutdown isn't scheduled, do nothing
                    return result;
                }
    ...
    processMessage(payload, message) {
        ...
        outgoingMessageHeaders = _.extend(outgoingMessageHeaders, getAdditionalHeadersFromSettings(settings), {
