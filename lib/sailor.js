...
class Sailor {
    ...
    processMessage(payload, message) {
        ...
        function processMessageWithModule(module) {
            ...
            function onTimeout() {
                log.info('Message execution stopped because of timeout');//@todo
                return onEnd();
            }
            ...
            function onEnd() {
                ...
                if (endWasEmitted) {
                    console.log('WARNING: End was emitted more than once!');
                    return;
                }
