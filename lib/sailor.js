...
Sailor.prototype.processMessage = function processMessage(payload, message) {
    ...
    var stepInfo = self.getStepInfo(stepId);
    var cfg = self.getStepCfg(stepId);
    ...
    return self.componentReader.loadTriggerOrAction(stepInfo.function)
    ...
    function processMessageWithModule(module) {
        ...
        function onUpdateKeys(keys) {
            ...
            return promise(self.apiClient.updateKeys(cfg._account, keys)
