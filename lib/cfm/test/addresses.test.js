...
// cfm.addCustomGlobalRule(globalResolver)

// let rule1 = {
//   result = targetWins()
//
//   if (!result) result = rejectEmpty()
//
...
const contactDataResolver = function (valueA, valueB) { // eslint-disable-line
  ...
  if (valueA !== valueB) return { value: valueA }; // to fix
  return { value: valueB }; // to fix
};
...
const person1 = {
  ...
  addresses: [
    { uid: '54321', city: 'Hamburg' },
  ],
  contactData: [
    {
      uid: '65432', type: 'Testtype', value: 'testval', description: 'some desc', contextRef: '12345abcd',
    },
  ],
};
...
describe('CFM Resolve', () => {
  test('should return the correct resolution', async () => {
    ...
    // {"addresses": [{"city": "Hamburg", "uid": "54321"}], "birthday": "12.12.1912", "contactData": [{"contextRef": "12345abcd", "description": "some desc", "type": "Testtype", "uid": "65432", "value": "testval"}], "displayName": "Jane Doe", "firstName": "Jane", "gender": "w", "jobTitle": "", "language": "en-US", "lastName": "Doe", "lastUpdate": "123456", "meta": {"3": null}, "middleName": "Schmuck", "nickname": "JD", "notes": "Premium customer, Is interested in XY.", "photo": "/jane.jpg", "uid": "12345", "updateEvent": "1000"}
