...
module.exports = class Server {
    constructor({ port, mongoDbConnection, eventBus }) {
        this.port = port || conf.port;
        this.eventBus = eventBus || new EventBus({ serviceName: conf.logging.namespace, rabbitmqUri: process.env.RABBITMQ_URI });
        this.app = express();
        ...
        // setup routes
        apiBase.use('/workflows', require('./../route/workflows')); // eslint-disable-line global-require
