...
module.exports = {
    ...
    endpoints: {
        iam: optional('ENDPOINT_IAM', 'https://iam.openintegrationhub.com' /* 'https://iam.openintegrationhub.com' */),
        flow: optional('ENDPOINT_FLOW', 'https://flow-repository.openintegrationhub.com' /* 'https://flow-repository.openintegrationhub.com' */),
