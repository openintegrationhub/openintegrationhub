              ...
              <div style={{ textAlign: 'center' }}>
                  ...
                  {this.state.selectedNode
                    && <div style={{ background: '', paddingBottom: 100, marginTop: 50 }}>
                        ...
                        Node name: <input type="text" id="editNodeName" name="editNodeName" value={this.state.editNodeName} onChange={(e) => this.handleChange(e)}/><br/>
                        <FormControl className={classes.formControl}>
                            <InputLabel id="demo-simple-select-label">Component</InputLabel>
                            <Select
                                labelId="demo-simple-select-label"
                        ...
                        <br/>
                        <br/>
                        Function: <input type="text" id="editFunction" name="editFunction" onChange={(e) => this.handleChange(e)}/>
                        <br/>
                        <FormControl className={classes.formControl}>
                            <InputLabel id="demo-simple-select-label">Secrets</InputLabel>
                            <Select
                        ...
                        <div style={{ marginTop: 10 }}> <button onClick={() => this.setState({ selectedNode: '' })}>Cancel</button>
                            <button onClick={() => this.handleEdit()}>Save</button></div>
